...
class GlassRecyclerContract extends Contract {
    constructor() {super('GlassRecycler')};

    async recyclingGlass(ctx, productId, processHash, processUri) {
        assertCan(ctx, 'Recycling');
...
module.exports = GlassRecyclerContract;