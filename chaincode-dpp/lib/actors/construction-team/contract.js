...
class ConstructionContract extends Contract {
  constructor() { super('ConstructionTeam'); }

  async constructProduct(ctx, productId, processHash, processUri, siteId = '') {
    assertCan(ctx, 'Construction');
    ...
    const ev = {
      ...
      at: txTimeISO(ctx),
      payload: { processHash, processUri, siteId }
    };
...
module.exports = ConstructionContract;